  ...
  <div class="card-widget-separator-wrapper">
    ...
    <div>
      ...
      <div class="row gy-4 gy-sm-1">
        <div class="col-sm-6 col-lg-12">
              <div class="col-xl-12">
              <h3>Patient Vitals Signs</h3>
                <div class="nav-align-top nav-tabs-shadow">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs_waiting_list" aria-controls="navs-top-home" aria-selected="true">
                        <b>Waiting List</b>
                      </button>
                    </li>
                    <li class="nav-item">
                      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs_vital_history" aria-controls="navs-top-profile" aria-selected="false">
                        <b>Vital Sign History</b>
                      </button>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs_admission_list" aria-controls="navs_completed" aria-selected="false">
                        <b>Admission List</b>
                      </button>
                    </li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="navs_waiting_list" role="tabpanel">
                       ...
                       <table class="table" id="app_list">
                           ...
                           <tbody>
                            ...
                            <tr>
                              <td>{{ $index + 1 }}</td>
                              <td>{{ $wait->attendance_date ? \Carbon\Carbon::parse($wait->attendance_date)->format('d-m-Y') : '--' }}</td>
                                  ...
                                  <div class="dropdown" align="center">
                                          <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                  <a class="dropdown-item"  href="#" data-bs-toggle="modal" data-bs-target="#add_vitals_signs" 
                                                      data-patient-id="{{ $wait->patient_id }}" 
                                                      data-opdnumber-id="{{ $wait->opd_number }}"
                                                      data-attendance-id="{{ $wait->attendance_id }}">
                                                    <i class="bx bx-edit-alt me-1"></i> Add Vital Sign
                                                  </a>
                                                  <a class="dropdown-item" data-id="{{ $wait->attendance_id}}" href="#">
                                                    <i class="bx bx-plus me-1"></i> Assign Doctor
                                                  </a>
                                            </div>
                                   </div>  
                              </td>
                    ...
                    <div class="tab-pane fade" id="navs_vital_history" role="tabpanel">
                      <!-- <p> --> <h4>Vital Signs History</h4>
                       <!-- Add date filter controls -->
                       <div class="row mb-3">
                         <div class="col-md-3">
                  ...
                  <div class="tab-pane fade" id="navs_admission_list" role="tabpanel">
