...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('patient')->group(function () {
        ...
        Route::get('/sponsor/data/{patient_id}', [SponsorController::class, 'get_patient_sponsors_json'])->name('sponsor.data.json');
        Route::post('/sponsor-update', [SponsorController::class, 'update_or_create_sponsor'])->name('sponsor.update');
